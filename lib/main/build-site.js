...
/**
 * Converts flodash method references into documentation links.
 *
 * @private
...
/**
 * Renames "_" id and anchor references to "flodash".
 *
 * @private
 * @param {Object} $ The Cheerio object.
 */
function renameflodashId($) {
	$('#_').attr('id', 'flodash')
	$('[href="#_"]').attr('href', '#flodash')
}
...
function build() {
	...
	fs.writeFile(path.join(docPath, 'node' + '.html'), __html, util.pitch)
