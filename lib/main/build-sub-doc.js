...
const _doc_nodedash_README = path.join(_doc_path_flodash, 'node.md')

const _flodashPkg = path.join(basePath, 'package.json')
const _nodedashPkg = path.join(_path_nodedash, 'package.json')
